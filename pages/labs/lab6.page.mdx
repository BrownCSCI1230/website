...
<ImageFigure
  images={[{ src: '/labs/lab6/lab06_output/ambient-task3.png', alt: 'TODO' }]}
  figNumber={6}
>
...
<ImageFigure
  images={[{ src: '/labs/lab6/lab06_output/diffuse.png', alt: 'TODO' }]}
  figNumber={7}
>
...
<ImageFigure
  images={[{ src: '/labs/lab6/lab06_output/task4.png', alt: 'TODO' }]}
  figNumber={8}
>
...
<ImageFigure
  images={[{ src: '/labs/lab6/lab06_output/specular.png', alt: 'TODO' }]}
  figNumber={9}
>
...
On finishing this task, you should be able to see the image below.
<ImageFigure
  images={[{ src: '/labs/lab6/lab06_output/task5.png', alt: 'TODO' }]}
  figNumber={10}
>
...
<ImageFigure
  images={[{ src: '/labs/lab6/lab06_output/final.png', alt: 'TODO' }]}
  figNumber={11}
