...
In Ray 1, you implemented the first two parts of the raytracing pipeline&mdash;**ray generation** and **intersection**&mdash;and colored in each pixel using **world-space surface normals**.

This is, of course, not our end goal. What we really want is for our raytracers to be able to produce **realistic images**, which would require rethinking _how we assign colors to pixels_. To that end, we're going to explore the subject of **lighting**: what it is, how it works, and how you can implement it.

### Objectives

1. Learn about **lighting**, especially **lighting models**,
2. Implement the **Phong lighting model**, and
...
:::todo
include function stub here
:::

The above function can be found in **`lightmodel.cpp`**. This is the _only_ file you have to modify.

That said, we strongly recommend that you at least take a look at the rest of the stencil, particularly `param.h` and `main.cpp`. The former declares global parameters (discussed in [a later section](#global_parameters)), along with some of the data structures you'll be working with, and the latter gives you a broader-picture understanding of what you're implementing.
...
<ImageFigure
  images={[{ src: '/labs/lab6/toneMapping.jpg', alt: 'TODO' }]}
  figNumber={5}
  figCaption={'todo'}
>
...
$$
  \large I_\lambda = k_a O_{a\lambda} + \sum_{i = 1}^{m} f_\text{att} I_{\lambda,i} \left[ k_d O_{d\lambda} \left( \bf\hat{N} \cdot \bf\hat{L}_i \right) + k_s O_{s\lambda} \left( \bf\hat{R}_i \cdot \bf\hat{V} \right)^n \right]
$$
...
<ImageFigure
  images={[{ src: '/labs/lab6/results/ambient.png', alt: 'TODO' }]}
  figNumber={6}
  figCaption={'todo'}
/>

$$
  \newcommand{\highlight}[1]{\colorbox{yellow}{$\color{black}\displaystyle#1$}}
...
<ImageFigure
  images={[{ src: '/labs/lab6/results/diffuse.png', alt: 'TODO' }]}
  figNumber={7}
  figCaption={'todo'}
/>
...
<ImageFigure
  images={[{ src: '/labs/lab6/results/ambient-diffuse.png', alt: 'TODO' }]}
  figNumber={8}
  figCaption={'todo'}
/>
...
<ImageFigure
  images={[{ src: '/labs/lab6/results/specular.png', alt: 'TODO' }]}
  figNumber={9}
  figCaption={'todo'}
/>
...
<ImageFigure
  images={[{ src: '/labs/lab6/results/ambient-diffuse-specular.png', alt: 'TODO' }]}
  figNumber={10}
  figCaption={'todo'}
/>
...
<ImageFigure
  images={[{ src: '/labs/lab6/results/final.png', alt: 'TODO' }]}
  figNumber={12}
  figCaption={'The final output'}
/>
