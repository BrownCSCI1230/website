// This is a modified version of rehype-prism-plus@1.4.1
...
const rehypePrismGenerator = (refractor) => {
  return (options = {}) => {
    ...
    function visitor(node, index, parent) {
      ...
      let codeLineArray = createLineNodes(refractorRoot.position.end.line)
      ...
      for (const [i, line] of codeLineArray.entries()) {
        ...
        // Line number
        if (
          (meta.toLowerCase().includes('showLineNumbers'.toLowerCase()) || options.showLineNumbers) &&
      ...
      if (codeLineArray.length > 0 && toString(codeLineArray[codeLineArray.length - 1]).trim() === '') {
        codeLineArray.pop()
      }
...
// Creates a rehype plugin which supports the "common" syntaxes specified here:
// https://www.npmjs.com/package/refractor#Data
